<div>
    <div class="card">
        ...
        <div class="card-header">
            <span class="block">all of your's job posts </span><br>
            <input type="text" placeholder=" searh" wire:model="search">
            @forelse ($checkAccount as $account)
                <a href="{{ route('jobpost.user.create', auth()->user()) }}"
            ...
            @empty
                <button class="btn btn-outline-primary btn-sm float-right emtpyAccount">
                    add new job post
                    <i class="fa fa-plus"></i>
                </button>
            @endforelse
                        ...
                        @forelse ($jobPosts as $jobPost)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button wire:click="$emit('deactive',{{ $jobPost }})"
                                        class="btn btn-outline-warning btn-sm deactiveBnt" data-toggle="modal"
                            ...
                            @if ($selectedJopPostToDeactive != null)
                                <form action="{{ route('jobPost.deactive', $selectedJopPostToDeactive->id) }}"
                                    ...
                                    <p class="alert alert-warning">
                                        <b>are you sure you want to deactive selected jop post</b>
                                    </p>
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-warning">deactive ad</button>
                                </form>
                            @endif
                        </div>
                    </div>
