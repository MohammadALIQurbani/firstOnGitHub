<div>
    ...
    @endif
    <button class="mr-2 float-right mb-2 btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#exampleModal">
            ...
            <main class="col-md-4 col-lg-3">
                <section class="card ">
                    ...
                    <div class="card-footer">
                        ...
                        <button wire:focus="$emit('deactive',{{ $ad }})"
                            class=" btn btn-outline-warning deactiveModalBtn btn-sm">
                            <span>deactive</span>
                            {{-- <i class="fa fa-cog"></i> --}}
                        </button>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Ad Modal</h5>
    ...
    <div class="modal fade deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">deactive Ad </h5>
                    <button type="button" class="close closeModal" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    @if ($selectedAdToDelete != null)
                        <form action="{{ route('ad.delete', $selectedAdToDelete->id) }}" method="post"
                            ...
                            <button type="button" class="btn btn-secondary closeModal"
                                data-dismiss="modal">Close</button>
                            <button class="btn btn-danger">deactive ad</button>
                        </form>
                    @endif
                </div>
            </div>
    ...
    <div class="modal fade deactiveModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if ($selectedAdToDeactive != null)
                        <form action="{{ route('ad.deactive', $selectedAdToDeactive->id) }}" method="post"
                            enctype="multipart/form-data">

                            @csrf
                            @method('patch')
                            <p class="alert alert-warning">
                                <b>are you sure you want to deactive the selected ad?</b>
                            </p>
                            <button type="button" class="btn btn-secondary closeModal"
                                data-dismiss="modal">Close</button>
                            <button class="btn btn-warning">delete ad</button>
                        </form>
                    @endif
                </div>
            </div>
