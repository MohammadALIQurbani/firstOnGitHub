<div>
    <div class="card">
        ...
        <div class="card-header">
            <span class="block">all deactive job posts </span><br>
                        ...
                        @forelse ($jobPosts as $jobPost)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-outline-success btn-sm hover"
                                        wire:click="$emit('active',{{ $jobPost->id }})" data-toggle="modal"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Active post modal</h5>
                        ...
                        <div class="modal-body">
                            @if ($selectedJopPostToActive != null)
                                <form action="{{ route('jobPost.active', $selectedJopPostToActive->id) }}"
                                    ...
                                    <button type="sumbit" class="btn btn-success">active jop post</button>
