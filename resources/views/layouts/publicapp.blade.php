...
<head>
    ...
    <link href="{{ asset('Selecao/assets/vendor/owl.carousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('Selecao/assets/vendor/owl.carousel/owl.carousel.min.js') }}"></script>
